 ...
 * Time: 19.27
 */
class VoceParBioIrlandesi extends VoceParBioValoriCorretti {

    private static String TITOLO_VOCE = VoceParBio.PATH_VOCE_PAR + 'Nordirlandesi'
    ...
    protected def getRecordsPieni() {
        ...
        records = Biografia.executeQuery("select title from Biografia where nazionalita='nordirlandese'")
